...
$the_launcher_add_section_arrays = array(
    ...
    'the_launcher_form_section'=>array(
        ...
        'args'=>array(
            'title'=>__('Form & Counter section setting','the-launcher'),
            'description'=>__('Info: "News Letter" And "Accesspress Socail Icon" Plugin Is Required To Add Form And Social Icon Below Of Countdown. Use "Subscribe Form" Widget Area To Add Form And Social Icon ','the-launcher'),
            'priority'=>3,
            'capability'=>'edit_theme_options',
            'theme_support'=>'',
    ...
    'the_launcher_pricing_section'=>array(
        ...
        'args'=>array(
            ...
            'description'=>__('To Add Pricing Table Go to Appearance->Widget Drag "The Launcher: Pricing Table" And Drop Into "Pricing Table" WIdget Area','the-launcher'),
            'priority'=>15,
            'capability'=>'edit_theme_options',
            'theme_support'=>'',
            'panel'=>'the_launcher_home_page_panel'
    ...
    'the_launcher_contact_section'=>array(
        ...
        'args'=>array(
            ...
            'description'=>__('Info:  "Ultimate Form Builder Lite" Plugin Is Required To Add Contact Form And To Add Map And Contact Go To Appearance->Widget Drag Text Widget Into "Home Contact Section" Widget Area And Use Map Iframe And Contact Form Shortcode','the-launcher'),
            'priority'=>23,
            'capability'=>'edit_theme_options',
            'theme_support'=>'',
            'panel'=>'the_launcher_home_page_panel'
...
$the_launcher_add_control_arrays = array(
    'the_launcher_enable_counter'=>array(
           ...
           'args'=>array(
               'label'      => __( 'Enable Form & Countdown Section', 'the-launcher' ),
    ...
    'the_launcher_form_cat'=>array(
        ...
        'args'=>array(
            'label' =>__('Form And Countdown BG Slider Category','the-launcher'),
            'description' => __('Select category for form and countdown background slide','the-launcher'),
            'section' =>'the_launcher_form_section',
            'type'=>'select',
    ...
    'the_launcher_client_cat'=>array(
        ...
        'args'=>array(
            'label' =>__('Choose post catrgoty for client','the-launcher'),
    ...
    'the_launcher_testimonial_cat'=>array(
        ...
        'args'=>array(
            'label' =>__('Choose page catrgoty for testimonial','the-launcher'),
    ...
    'the_launcher_enable_footer'=>array(
        ...
        'args'=>array(
            'label'=>__('Disable Footer','the-launcher'),
...
$wp_customize->add_section(
        'the_launcher_features',
        array(
          'title'           =>  __('Important Links', 'the-launcher'),
          'priority'        =>  '600', )
    );
    
    $wp_customize->add_setting('the_launcher_theme_info',array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));
$wp_customize->add_control( new the_launcher_Custom_Control( $wp_customize ,'the_launcher_theme_info',array(
        'label' => __( 'The Launcher Pro Features' , 'the-launcher' ),
        'section' => 'the_launcher_features',
    )));