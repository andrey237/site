...
<div
  ...
  <?php endif ?>
    ...
    $this->start_element('nextgen_gallery.image_panel', 'item', $image);
		...
		<div id="<?php echo esc_attr('ngg-image-' . $i) ?>" class="wrap-frame ngg-gallery-thumbnail-box" <?php if ($style) echo $style; ?>>
			<?php
      ...
      <div class="frame ngg-gallery-thumbnail">
          <a class="image-container"
             href="<?php echo esc_attr($storage->get_image_url($image, 'full', TRUE))?>"
